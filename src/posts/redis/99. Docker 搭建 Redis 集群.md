...
tag:
  ...
  - 环境配置
  - 高可用
excerpt: 使用 Docker 搭建主从复制、Sentinel 集群、Cluster 集群
order: 99
---
...
port 6380
bind 0.0.0.0
# 可通过 docker inspect 容器 ID 查看主节点的 IP
...
至少需要 1 个主节点，2 个从节点，和 3 个 Sentinel 节点
...
# 依次传入主节点名称（使用默认的即可）、主节点 IP、主节点端口号、最小投票数
